...
void platform_window_normalize_client_coords(const struct platform_window* p_window, int client_x, int client_y, float* p_x, float* p_y);
void platform_window_client_coords_to_ndc(const struct platform_window* p_window, int client_x, int client_y, float* p_ndc_x, float* p_ndc_y);
void platform_window_client_to_world_ray(const struct platform_window* p_window, const float* p_camera_matrix, int client_x, int client_y, float* p_result);
