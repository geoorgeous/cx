...
extern inline void vec3_copy(const float* p_v, float* p_out);
extern inline void vec3_set_s(float s, float* p_out);
extern inline void vec3_set(float i, float j, float k, float* p_out);
extern inline void vec3_clr(float* p_out);
extern inline void vec3_add(const float* p_v1, const float* p_v2, float* p_out);
extern inline void vec3_add_s(const float* p_v, float s, float* p_out);
extern inline void vec3_sub(const float* p_v1, const float* p_v2, float* p_out);
extern inline void vec3_sub_s(const float* p_v, float s, float* p_out);
extern inline void vec3_mul(const float* p_v1, const float* p_v2, float* p_out);
extern inline void vec3_mul_s(const float* p_v, float s, float* p_out);
extern inline void vec3_div(const float* p_v1, const float* p_v2, float* p_out);
extern inline void vec3_div_s(const float* p_v, float s, float* p_out);
...
extern inline void vec3_norm(const float* p_v, float* p_out);
extern inline void vec3_cross(const float* p_v1, const float* p_v2, float* p_out);
...
extern inline void vec3_min(const float* p_v1, const float* p_v2, float* p_out);
extern inline void vec3_max(const float* p_v1, const float* p_v2, float* p_out);
...
extern inline void vec3_inv(const float* p_v, float* p_out);
