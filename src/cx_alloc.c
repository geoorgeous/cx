...
static int cx_alloc_ring_enough_space(const struct cx_alloc_ring* p_ring, size_t size);
...
int cx_alloc_ring_push(struct cx_alloc_ring* p_ring, const void* p_src, size_t size) {
	...
	while(!cx_alloc_ring_enough_space(p_ring, size)) {
		cx_alloc_ring_evict_oldest(p_ring);
	}
...
int cx_alloc_ring_enough_space(const struct cx_alloc_ring* p_ring, size_t size) {
